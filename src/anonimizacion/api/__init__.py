...
def registrar_handlers():
    import anonimizacion.modulos.anonimizacion.aplicacion

def importar_modelos_alchemy():
    import anonimizacion.modulos.anonimizacion.infraestructura.dto
...
def create_app(configuracion={}):
    ...
    app.config['TESTING'] = configuracion.get('TESTING')
     ...
     # Inicializa la DB
    from anonimizacion.config.db import init_db, database_connection
